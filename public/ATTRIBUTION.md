...
PT Atlas is a fork of [Human Atlas](https://github.com/ashemag/human-atlas) by ashemag, adapted as a PT (personal trainer) consultation tool. The 3D anatomy data and its CC BY 4.0 attribution above are unchanged. This fork adds a curated, bilingual (English/Vietnamese) library of muscle-group content — common names, function, suggested exercises, and safety notes — layered on top of the existing muscular-system meshes; it does not add, remove, or modify any geometry.
